 ...
 */
final class Version20241021083856 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dette (id SERIAL NOT NULL, client_id INT NOT NULL, data DATE NOT NULL, montant INT NOT NULL, montan_verser INT NOT NULL, PRIMARY KEY(id))');
