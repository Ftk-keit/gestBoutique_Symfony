 ...
 */
final class Version20241020220433 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "user" (id SERIAL NOT NULL, client_id INT DEFAULT NULL, nom VARCHAR(50) NOT NULL, prenom VARCHAR(50) NOT NULL, password VARCHAR(255) NOT NULL, is_active BOOLEAN NOT NULL, login VARCHAR(50) NOT NULL, PRIMARY KEY(id))');
